...
import itertools
from typing import List, Optional, Tuple, Union, Literal, Iterable, Iterator, Sequence
...
def _batched_slice(full_batch, full_meta: Optional[List[dict]], batch_size: int) -> Iterator[Tuple[Sequence, List[dict]]]:
