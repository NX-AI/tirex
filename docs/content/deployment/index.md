...
export const apiCards = [
  {
    type: 'link',
    label: 'CPU Container',
    href: 'https://github.com/NX-AI/tirex/pkgs/container/tirex-cpu',
    description: 'TiRex docker container for CPU based inference.',
  },
  {
    type: 'link',
    label: 'GPU Container',
    href: 'https://github.com/NX-AI/tirex/pkgs/container/tirex-gpu',
    description: 'TiRex docker container for GPU based inference.',
  },
];

<DocCardList items={apiCards} />
...
For more information about building and testing the containers, have a look at the [docker readme](https://github.com/NX-AI/tirex/blob/main/inference/README.md).


## ONNX Export
- An ONNX build of TiRex is currently in progress and will be published here once it is ready.
